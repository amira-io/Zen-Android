...
import io.amira.zen.layout.slider.ZenSlidingMenu.OnClosedListener;
import io.amira.zen.layout.slider.ZenSlidingMenu.OnOpenedListener;

/**
 * Created by giovanni on 28/12/13.
 */

public class ZenViewAbove extends ViewGroup {

    private static final String TAG = "ZenViewAbove";
    ...
    public ZenViewAbove(Context context) {
        this(context, null);
    }

    public ZenViewAbove(Context context, AttributeSet attrs) {
        super(context, attrs);
        initCustomViewAbove();
    }
    ...
    public void setZenViewBehind(ZenViewBehind zvb) {
        mViewBehind = zvb;
    }
    ...
    protected int mTouchMode = ZenSlidingMenu.TOUCHMODE_MARGIN;
    ...
    private boolean thisTouchAllowed(MotionEvent ev) {
        ...
        if (isMenuOpen()) {
            ...
            switch (mTouchMode) {
                ...
                case ZenSlidingMenu.TOUCHMODE_NONE:
                    return false;
    ...
    public void scrollTo(int x, int y) {
        ...
        ((ZenSlidingMenu)getParent()).manageLayers(getPercentOpen());
    }
