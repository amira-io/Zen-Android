 ...
 * @version 1.3.0
 */
public class ZenListView extends ListView{
    ...
    public ZenListView(Context context){
        super(context);
        init();
    }

    public ZenListView(Context context, AttributeSet attrs){
        super(context, attrs);
        init();
    }

    public ZenListView(Context context, AttributeSet attrs, int defStyle){
